...
namespace miruy {
    ...
    public:
        ...
        int send(const iovec* buffs, size_t len, int flag = 0);
        int sendTo(const void* buff, size_t len, const Address::ptr to, int flag = 0);
        int sendTo(const iovec* buffs, size_t len, const Address::ptr to, int flag = 0);

        int recv(void* buff, size_t len, int flag = 0);
        int recv(iovec* buffs, size_t len, int flag = 0);
        int recvFrom(void* buff, size_t len, Address::ptr from, int flag = 0);
        int recvFrom(iovec* buffs, size_t len, Address::ptr from, int flag = 0);
